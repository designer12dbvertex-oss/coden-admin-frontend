...
export default function OrdersTable() {
  ...
  React.useEffect(() => {
    const fetchSubcategories = async () => {
      ...
      try {
        ...
        const subcategoriesData = Array.isArray(response.data.data)
          ? response.data.data
          : [];
  ...
  const validateForm = () => {
    ...
    if (
      serviceProviderForm.category_id &&
  ...
  const createServiceProvider = async () => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description:
          err.response?.data?.message || 'Failed to create service provider',
        status: 'error',
        duration: 3000,
        isClosable: true,
        position: 'top-right',
        ...
        <Flex direction="column" gap="4">
          ...
          <Flex gap="4" direction={{ base: 'column', md: 'row' }}>
            <FormControl isRequired isInvalid={!!errors.phone}>
              ...
              <Input
                ...
                onChange={handleServiceProviderInputChange}
              />
              {errors.phone && (
          ...
          <Flex gap="4" direction={{ base: 'column', md: 'row' }}>
            <FormControl>
              ...
              <Input
                name="location"
                value={serviceProviderForm.location}
                onChange={handleServiceProviderInputChange}
              />
            </FormControl>
            <FormControl>
              ...
              <Input
                ...
                value={serviceProviderForm.current_location}
                onChange={handleServiceProviderInputChange}
              />
            </FormControl>
          </Flex>
          ...
          <Flex gap="4" direction={{ base: 'column', md: 'row' }}>
            <FormControl>
              ...
              <Input
                name="full_address"
                value={serviceProviderForm.full_address}
                onChange={handleServiceProviderInputChange}
              />
            </FormControl>
            <FormControl>
              ...
              <Input
                name="landmark"
                value={serviceProviderForm.landmark}
                onChange={handleServiceProviderInputChange}
              />
            </FormControl>
          </Flex>
          ...
          <Flex gap="4" direction={{ base: 'column', md: 'row' }}>
            <FormControl>
              ...
              <Input
                name="colony_name"
                value={serviceProviderForm.colony_name}
                onChange={handleServiceProviderInputChange}
              />
            </FormControl>
            <FormControl>
              ...
              <Input
                name="house_number"
                value={serviceProviderForm.house_number}
                onChange={handleServiceProviderInputChange}
              />
            </FormControl>
          </Flex>
