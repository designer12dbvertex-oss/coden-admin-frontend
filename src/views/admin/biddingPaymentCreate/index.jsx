...
export default function BiddingPaymentCreate() {
	...
	const fetchOrders = async () => {
	  try {
		...
		const formattedData = response.data.data.map((item) => ({
		  ...
		  paid: item.service_payment?.amount || 0,
		  remaining_amount: item.service_payment?.remaining_amount || 0,
