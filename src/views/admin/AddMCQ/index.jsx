...
export default function MCQManagement() {
  ...
  const filteredMCQs = mcqs
    .filter((m) => {
      // Manual mode → no testId
      if (finalMode === 'manual') {
        return !m.testId;
      }

      // Exam mode → testId exists
      if (finalMode === 'exam') {
        return !!m.testId;
      }

      // Regular mode → testId exists
      if (finalMode === 'regular') {
        return !!m.testId;
      }
...
//     const cour =
//       sub?.courseId || ss?.courseId || chap?.courseId || selectedTopic.courseId;
//     const cId = cour?._id || cour || '';
...
//     const fetchAll = async () => {
//       try {
//         const [courseRes, tagRes, mcqRes, testsRes, topicsRes] =
//           await Promise.all([
//             axios.get(`${baseUrl}/api/admin/courses`, { headers }),
//             axios.get(`${baseUrl}/api/admin/tags`, { headers }),
//             axios.get(`${baseUrl}/api/admin/mcqs`, { headers }),
...
//       testIdsArray = [
//         typeof mcq.testId === 'object' ? mcq.testId._id : mcq.testId,
//       ];
//     }
...
//       'chapterId',
//       finalMode === 'regular'
//         ? selectedTestDetails?.chapterId || formData.chapterId
//         : formData.chapterId,
//     );
//     data.append('topicId', formData.topicId);
...
//             </Text>
//             {finalMode === 'manual' && (
//               <Badge colorScheme="purple">Manual Mode</Badge>
//             )}
//           </HStack>
//         </Flex>
...
//                     <Icon as={MdFlashOn} me="1" /> Quick Select Topic
//                     (Auto-fill)
//                   </FormLabel>
//                   <Select
...
//                   value={formData.explanationText}
//                   onChange={(v) =>
//                     setFormData((p) => ({ ...p, explanationText: v }))
//                   }
//                   modules={quillModules}
//                   formats={quillFormats}
//                 />
