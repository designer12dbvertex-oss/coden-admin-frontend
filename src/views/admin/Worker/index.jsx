...
//       }
//       setLoading(true);
//       const response = await axios.get(`${baseUrl}api/worker/getAllWorkers`, {
...
export default function WorkersTable() {
  ...
  const handleExportCsv = () => {
    ...
    link.setAttribute('download', 'workers_data.csv');
    ...
    toast({
      ...
      description: 'Worker data has been exported to CSV.',
      status: 'success',
      duration: 3000,
      isClosable: true,
      position: 'top-right',
    ...
    >
      <Flex px="0px" mb="20px" justifyContent="space-between" align="center">
        ...
        <Button
          ...
          colorScheme="green" // You can choose your preferred color scheme
