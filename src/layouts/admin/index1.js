...
export default function Dashboard(props) {
  ...
  const getRoutes = (routes) => {
    ...
    allRoutes.push(
      <Route
        path="/directOrder/:user_id"
        element={<UserDirectOrder />}
        key="UserDirectOrder"
      />,
    );
    allRoutes.push(
      <Route
        path="/bidding_Order/:user_id"
        element={<UserBiddingOrder />}
        key="UserBiddingOrder"
      />,
    );
    allRoutes.push(
      <Route
        path="/emergency_Order/:user_id"
        element={<UserEmergencyOrder />}
        key="UserEmergencyOrder"
      />,
    );
    allRoutes.push(
      <Route
        path="/details/:service_provider_id"
    ...
    allRoutes.push(
      <Route
        path="/Dispute/UserDetails/:user_id"
        element={<ViewDisputeUser />}
        key="viewDisputeUser"
      />,
    );
    allRoutes.push(
      <Route
        path="/biddingOrder/:orderId"
        element={<ViewBiddingOrder />}
        key="viewBiddingOrder"
      />,
    );
    allRoutes.push(
      <Route
        path="/emergencyOrder/:orderId"
        element={<ViewEmergencyOrder />}
        key="viewEmergencyOrder"
      />,
    );
    allRoutes.push(
      <Route
        path="/createServiceProvider"
        element={<ViewCreateServiceProvider />}
        key="viewCreateServiceProvider"
      />,
    );
    allRoutes.push(
      <Route
        path="/createSubadmin"
        element={<ViewCreateSubadmin />}
        key="ViewCreateSubadmin"
      />,
    );
    return allRoutes;
  };
